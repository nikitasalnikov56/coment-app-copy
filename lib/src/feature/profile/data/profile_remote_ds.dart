...
// Future<Map<String, dynamic>> uploadAvatar(FormData formData);
// ///
...
//   await restClient.put('auth/me', body: data);
// }

// @override
// Future<Map<String, dynamic>> uploadAvatar(FormData formData) async {
//   return await restClient.post('auth/me/avatar', body: formData);
// }
// ///
