...
// Создаем триггер для тряски
  late final StreamShakeTrigger _shakeTrigger =
      StreamShakeTrigger(_shakeController.stream);
  ...
  void dispose() {
    ...
    // 3. Обязательно закрываем контроллер и триггер
          ...
          state.maybeWhen(
            ...
            error: (message, sendedOldValue, authErrorResponse) {
              ...
              final String errorMessage =
                  context.localized.invalidEmailOrPassword;
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style:
                                  AppTextStyles.fs26w700.copyWith(height: 1.25),
                            ),
                            const Gap(20),
                            Text(
                            ...
                            ValueListenableBuilder(
                              ...
                              builder: (context, v, c) {
                                return CustomValidatorTextfield(
                                  ...
                                  validator: (String? value) {
                                    // Если в _passwordError лежит текст (например, из BlocConsumer), показываем его
